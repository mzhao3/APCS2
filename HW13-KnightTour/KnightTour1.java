...
class TourFinder
{
	...
	//and recursively generate tour possibilities from current pos
	    ...
	    /* YOUR KODE HERE */
	    findTour( x + 2, y + 1, moves);//a
	    findTour( x + 1, y + 2, moves);//b
	    findTour( x - 1, y + 2, moves);//c
	    findTour( x - 2, y + 1, moves);//d
	    findTour( x - 2, y - 1, moves);//e
	    findTour( x - 1, y - 2, moves);//f
	    findTour( x + 1, y - 2, moves);//g
	    findTour( x + 2, y - 1, moves);//h
